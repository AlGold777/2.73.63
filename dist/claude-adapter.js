// Auto-generated by scripts/build-bundles.js @ 2026-02-16T19:15:08.605Z
(function () {
          ...
          try {
            await withSmartScroll(async () => {
              ...
              if (cleaned !== lastResponseCache || forceEmitOnUnchanged) {
                ...
                const payload = normalizeResponsePayload({ text: cleaned, html: lastResponseHtml }, lastResponseHtml);
                chrome.runtime.sendMessage({
                  type: 'LLM_RESPONSE',
                  llmName: MODEL,
                  answer: payload.text,
