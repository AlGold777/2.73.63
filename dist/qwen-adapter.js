// Auto-generated by scripts/build-bundles.js @ 2026-02-16T19:15:08.607Z
(function () {
...
const keepAliveMutex = (() => {
  ...
  function extractMessageText(element) {
    ...
    let buf = best;
    if (!buf) {
      const textContainers = element.querySelectorAll('div[lang], div[dir="auto"], p, li, pre, code, blockquote');
          ...
          try {
            await withSmartScroll(async () => {
              ...
              if (cleaned && cleaned !== lastResponseCache) {
                ...
                lastResponseHtml = '';
                sendResult({ text: cleaned, html: lastResponseHtml }, true, { isEvaluator: false, meta: msg?.meta || null });
